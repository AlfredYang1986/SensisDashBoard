...
object SplunkQueryHelper {
  ...
  /**
   * @param left: previous query
   * @param right: current  query
   * @param func : function which holds the conditions for comparison
  ...
  /**
   * Provide conditions for comparing query/location elements.
   */
